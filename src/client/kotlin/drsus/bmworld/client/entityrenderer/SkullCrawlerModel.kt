...
class SkullCrawlerModel(root: ModelPart) : EntityModel<SkullCrawlerEntityRenderState>(root) {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    var dancing = SkullCrawlerAnimation.dance.bake(root)
    var walking = SkullCrawlerAnimation.walk.bake(root)

    private var skullcrabby: ModelPart? = null
    private var body: ModelPart? = null
    private var skull: ModelPart? = null
    private var arm_rechts: ModelPart? = null
    private var arm_links: ModelPart? = null
    private var leg_left_1: ModelPart? = null
    private var leg_right_1: ModelPart? = null
    private var leg_left_2: ModelPart? = null
    private var leg_right_2: ModelPart? = null
    private var leg_left_3: ModelPart? = null
    private var leg_right_3: ModelPart? = null
    fun skullcrabby(root: ModelPart) {
    ...
    companion object {
        fun createBodyLayer(): LayerDefinition {
            ...
            val skullcrabby = partdefinition.addOrReplaceChild(
                "skullcrabby",
            ...
            val leg_right_3: PartDefinition? = skullcrabby.addOrReplaceChild(
                "leg_right_3",
